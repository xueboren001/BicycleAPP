...
public class Register1Activity extends Activity implements OnClickListener,OnCheckedChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LogUtil.toastCustome(this, "register1Activity onCreate...");
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.bicycle_register_activity_first_1);
		context = this;
		initViews();
	}
