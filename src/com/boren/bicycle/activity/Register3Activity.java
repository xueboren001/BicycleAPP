...
public class Register3Activity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bicycle_register_activity_second);
		context = this;
		initViews();
	}
		...
		public void handleMessage(Message msg) {
			if(msg.what==Bicycle.MESSAGEWHAT.MESSAGE_WHAT_SET_PASSWORD_CODE){
				...
				if(result.isResultOk()){
					...
					Intent intent = new Intent(context, Register4Activity.class);
